# Store release evidence through 1.0.6

Historical records moved from the [submission checklist](../../packaging/store/SubmissionChecklist.md) on 2026-09-05. Dates, hashes, user confirmations and Partner Center statuses describe those recorded runs only; they do not prove current publication or a later release. Do not load this archive for ordinary runtime tasks.
